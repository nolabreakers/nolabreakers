export let members = [
  {
    ...
    "bio" : `<p>Jeffrey, a New Orleans native, is known for hosting his own local dance competitions and bringing the dance community together. Jeffrey is also known for his swift footwork and handstand techs. He has been featured in commercials and movies such as "Walk Hard." Jeffrey spends a lot of time dedicated to training long hours and traveling to perform at top music festivals across the country.
    </p>`
  },
  {
    "name" : "RoboSteve",
  ...
  },
  {
    ...
    "video" : "BGEM1jzXwf8",
    "bio" : `<p>Bj has been a professional dancer for twenty years. Stress is originally from Las Vegas and became a member of the New Orleans dance community a few years back. BJ is well known for his versatility in all aspects of dance such as house, footwork and power moves. BJ has competed and performed on an international level for many years and blows the crowd away with his bold, well rounded style of dance. </p>`
  },
  {
    "name" : "Sykedelic",
    "image" : {         
    ...
    "bio" : `<p>Oliver is a New orleans native with over ten years of break dancing experience. After teaching himself from instructional break dance videos and talented friends he mastered his craft. Oliver is well known for his crowd pleasing power moves and dynamic tricks. Oliver has competed locally and nationally. He has performed in NBA halftime shows, appeared in movies such as "Kidnap” starring Halle Berry. Oliver also performs with his dance crew at Buku Fest every year in New Orleans. </p>`
  },
  {
    "name" : "Jordan",
    "image" : {         
    ...
    "bio" : `<p>Jordan has been a part of the New Orleans dance community for many years. After training with the Nola Breakers, Jordan went from being a complete rookie to being one of the top breakdancers on the team. His clean and flashy power moves  has earned Jordan a spot on the Nola Breakers squad. 
    </p>`
  }
]
 /* {
      ...
      <p>Ut porttitor rhoncus diam, vel fermentum dui pretium vitae. Integer ornare placerat libero, eget viverra neque elementum eu. Nam risus eros, dapibus eu porttitor sed, maximus quis neque. Suspendisse congue gravida justo a scelerisque. Sed nec sagittis eros. Vestibulum in scelerisque metus, eget dapibus lorem. Pellentesque condimentum volutpat erat, a pulvinar magna condimentum eu. Mauris convallis, ipsum at fermentum venenatis, nunc ligula sagittis orci, quis auctor dui enim eu ante. Quisque risus metus, congue ut gravida ut, facilisis ut velit. Sed et suscipit erat, ut scelerisque urna. Nulla porttitor, neque quis luctus auctor, arcu nunc iaculis ante, eget viverra ipsum est et metus. Nam gravida accumsan elit, et condimentum nulla. Nunc lobortis mauris et ligula semper, eleifend luctus magna sagittis. Phasellus feugiat mollis mi fringilla egestas. Aenean fringilla lacus dui, sed faucibus dui elementum et. Suspendisse tristique sagittis porttitor.</p>
      
      <p>Orci varius natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Morbi ut tincidunt nulla, non interdum elit. Etiam sit amet commodo justo. Curabitur ac dui posuere, aliquet felis at, dignissim quam. Integer nibh erat, feugiat et arcu a, accumsan blandit quam. Duis eu nisl vehicula lectus laoreet porttitor. Nullam lacinia tellus elit, ut feugiat purus porta non.</p>`
  },
  {
    "name" : "Calypso",
    "image" : {         
